...
import { getAppointments, getAppointmentByStylistId, getUpcomingAppointmentsByStylistId, createAppointment, updateAppointment, deleteAppointment, getAppointment } from "@/api/appointments";

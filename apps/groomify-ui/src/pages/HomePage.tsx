            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8">
                  Our certified groomers are trained in animal behavior and
                  handling, ensuring that even the most nervous pets feel safe
                  and loved in our care. We use only high-quality,
                  hypoallergenic products to keep your pet's skin and coat
                  healthy.
                </p>
        ...
        <section className="py-20 bg-teal-50">
          <div className="max-w-4xl mx-auto text-center px-4">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Book an appointment today and see the FreshPaws difference. Spots
              fill up fast!
            </p>
            <button

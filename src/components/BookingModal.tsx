...
export function BookingModal({ isOpen, onClose }: BookingModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(`Request sent for ${formData.petName}! We will contact you at ${formData.phone} to confirm.`);
    onClose();
  };
        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="flex justify-between items-center mb-5">
              <h3 className="text-xl font-bold text-gray-900" id="modal-title">Book an Appointment</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="notes" className="block text-sm font-medium text-gray-700">Special Requests / Notes</label>
                <textarea
                  rows={3}
                  className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-teal-500 focus:border-teal-500"

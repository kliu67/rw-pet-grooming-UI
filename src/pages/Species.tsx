  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">{t('species.title')}</h1>
          <p className="text-gray-500 mt-1">{t('species.subtitle')}</p>
        </div>
        <button className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg font-medium transition-colors"
          // onClick={()=>setIsOpen(true)}
           onClick={()=>openModal(MODAL_TYPES.CREATE_SERVICE)}
        >
